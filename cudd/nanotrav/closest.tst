...
# /root/sv-sampler-lab/cudd/nanotrav/.libs/nanotrav -p 1 -reordering genetic -drop -closest ./nanotrav/closest.blif
# CUDD Version 3.0.0
...
Maximum resident size            =  7888K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1294
Swaps = 0
Input blocks = 0
Output blocks = 8
