...
# /root/sv-sampler-lab/cudd/nanotrav/.libs/nanotrav -p 1 -ordering dfs -autodyn -automethod sifting -reordering sifting -drop ./nanotrav/C880.blif
# CUDD Version 3.0.0
...
Number of cache hits: 28648
Number of cache insertions: 30601
Number of cache collisions: 2461
Number of cache deletions: 28140
Cache used slots = 18.18% (expected 0.00%)
Soft limit for cache size: 62464
Number of buckets in unique table: 15616
Used buckets in unique table: 20.88% (expected 20.96%)
...
Maximum resident size            =  8076K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 2011
Swaps = 0
Input blocks = 0
Output blocks = 8
