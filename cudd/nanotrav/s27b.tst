...
# /root/sv-sampler-lab/cudd/nanotrav/.libs/nanotrav -p 1 -ordering dfs -reordering win4 -verify ./nanotrav/s27.blif ./nanotrav/s27b.blif
# CUDD Version 3.0.0
...
Maximum resident size            =  7900K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1293
Swaps = 0
Input blocks = 0
Output blocks = 8
